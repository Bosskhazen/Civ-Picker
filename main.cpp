...
void print_result (vector<string> const&, int const&); // announcing the results
...
void print_result (vector<string> const& l, int const& r){
    cout<< "Picked leader/civilization : " << l[r-1];
    cout<< endl;
